...
public class Inicializador implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		contextoSpring.setConfigLocation("com.atsistemas.curso.configuracion");
		DispatcherServlet servlet = new DispatcherServlet(contextoSpring);
		Dynamic dynamic = servletContext.addServlet("dispatcherServlet", servlet);
		dynamic.addMapping("/"); // Gestiona todas las peticiones a la aplicación
	}
